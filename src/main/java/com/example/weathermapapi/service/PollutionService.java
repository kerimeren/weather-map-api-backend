...
import com.example.weathermapapi.dto.*;
import com.example.weathermapapi.model.Pollution;
import com.example.weathermapapi.repository.IPollutionRepository;
import com.example.weathermapapi.exception.DateOutOfRangeException;
...
import com.example.weathermapapi.util.PollutionUtil;
...
public class PollutionService implements IPollutionService
{
    ...
    private CategoriesDto determineCategories(City city, LocalDate date)
    {
        ...
        String coValue = PollutionUtil.determineCoValue(avgCo);
        String o3Value = PollutionUtil.determineO3Value(avgO3);
        String so2Value = PollutionUtil.determineSo2Value(avgSo2);
